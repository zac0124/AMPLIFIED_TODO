...
class UntitledModel extends Model {
  ...
  const UntitledModel._internal({required this.id, required name, description, required isComplete, createdAt, updatedAt}): _name = name, _description = description, _isComplete = isComplete, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory UntitledModel({String? id, required String name, String? description, required bool isComplete}) {
  ...
  UntitledModel copyWith({String? id, String? name, String? description, bool? isComplete}) {
    return UntitledModel._internal(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: UntitledModel.NAME,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: UntitledModel.DESCRIPTION,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
